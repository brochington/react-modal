...
var ModalPortal = module.exports = React.createClass({
  ...
  componentDidMount: function() {
    console.log("ModalPortal componentDidMount");
  ...
  componentWillUnmount: function() {
      console.log("ModalPortal componentWillUnmount", this.props);
  ...
  componentWillReceiveProps: function(newProps) {
      console.log('ModalPortal componentWillReceiveProps');
  ...
  componentWillUpdate() {
    console.log('ModalPortal componentWillUpdate', this.props, document.querySelector(".ReactModal__Overlay"));
  },
  ...
  afterClose: function() {
    console.log("ModalPortal afterClose");
  ...
  requestClose: function() {
    console.log("ModalPortal requestClose");
    if (this.ownerHandlesClose())
  ...
  render: function() {
    console.log("ModalPortal render");
