...
var Modal = module.exports = React.createClass({
  ...
  beforeModalDidMount: function(func) {
    console.log("beforeModalDidMount!!", func);
    if (func) {
      ...
      console.log(this.beforeModalDidMountCallbacks);
    }
  },

  beforeModalWillUnmount: function(func) {
      console.log("beforeModalWillUnmount", func);
      if (func) {
        ...
        console.log(this.beforeModalUmountsCallbacks)
      }
  },
  ...
  renderPortal: function(props) {
    ...
    sanitizeProps(props);
    props.beforeModalUmountsCallbacks = this.beforeModalUmountsCallbacks;
